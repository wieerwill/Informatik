...
\begin{questions}
  ...
  \begin{parts}
    ...
    \begin{solution}
      Rauschen/Signalstörung rückführung in Filter um Originalsignal ohne Rauschen zu erhalten
      \begin{center}
        \includegraphics[width=.6\linewidth]{Assets/Biosignalverarbeitung-adaptiver-filter-aufbau.png}
      \end{center}
    \end{solution}
