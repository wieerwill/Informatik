...
\begin{multicols}{3}\scriptsize
      ...
      Nehmen wir an, ein Absender verschlüsselt Klartextnachrichten $P_1,
            P_2, ...$ zu Chiffretextnachrichten $C_1, C_2, ...$
      ...
      \begin{itemize*}
            ...
            \end{itemize*}
            \item Kann über $\mathbb{R}$ berechnet werden, aber in der
            Kryptographie werden $\mathbb{Z}_p$ und
            $GF(2^n)$ verwendet
            \begin{itemize*}
      ...
      \begin{itemize*}
            ...
            $\alpha=\begin{cases}
                        ...
                        \quad\text{ for } P=Q
                  \end{cases}$
            \item Ergebnis der Punktaddition, wobei $(x_r,y_r)$ bereits der
            Spiegelpunkt $(-R)$ ist
      \end{itemize*}
      ...
      \begin{itemize*}
            ...
            $\mathbb{R}$ gewählt werden
            \item Für $\mathbb{Z}_p$ und $GF(2^n)$ muss das
      ...
      \begin{itemize*}
            ...
            \end{itemize*}
            \item Wir haben:
            $P(n,k)=1-Q(n,k)=1-\frac{n!}{(n-k)!\times
                        n^k}=1-\frac{n\times(n-1)\times...\times(n-k+1)}{n^k}=1-,,(1-\frac{1}{n})\times(1-\frac{2}{n})\times...\times(1-\frac{k-1}{n})''$
            \item Wir werden die folgende Ungleichung verwenden: $(1-x)
                  \leq e^{-x}$ für alle $x \geq 0$
            \item So:
            $P(n,k)>1-,,(e^{-1/n})\times(e^{-2/n})\times...\times(e^{-(k-1)/n})''=1-e^{\frac{-k\times(k-1)}{2n}}$
            ...
            Wahrscheinlichkeit $\geq 0,5$ vorhanden sind?
            \begin{itemize*}
      ...
      \begin{itemize*}
            ...
            sondern verschlüsselt UND authentifiziert (Blöcke $P_0...P_n$)
            \item Manchmal müssen zusätzliche Daten authentifiziert werden (z.B.
            Paketköpfe), im Folgenden mit $A_0...A_m$ bezeichnet
