...
\begin{lstlisting}[language=C++]
template<typename T> // typename keyword $\rightarrow$ deklariert T als Typ
T max(T a, T b) {
  return (a > b ? a : b);
}
\end{lstlisting}
...
\begin{center}
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-Lambda_Abstraktion}
\end{center}
...
$\lambda x.xx$ wendet sein Argument auf das Argument selbst an $\Rightarrow$ dadurch reproduziert $\omega$ sich selbst.
  ...
  \begin{center}
    ...
    \includegraphics[width=0.25\linewidth]{Assets/Programmierparadigmen-010.png}
  \end{center}
  ...
  \begin{itemize*}
    ...
    \end{itemize*}
    \begin{center}
      \includegraphics[width=0.4\linewidth]{Assets/Programmierparadigmen-012.png}
      \includegraphics[width=0.4\linewidth]{Assets/Programmierparadigmen-013.png}
    \end{center}
    \item Erläuterungen:
    \begin{itemize*}
...
$\Rightarrow$ call-by-name, call-by-value
  ...
  \begin{figure}[!tbp]
    \centering
    \begin{minipage}[b]{0.45\textwidth}
      \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-Shared-Memory-vs-Message-Passing}
  ...
  \begin{figure}[!tbp]
    ...
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
      \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-Taskparallelität}
  ...
  \begin{itemize*}
    ...
    \begin{lstlisting}
    Pid = spawn(fun() $\rightarrow$ any_func(Arg1, Arg2, ...) end)
    \end{lstlisting}
  \end{itemize*}
  ...
  \begin{figure}[!tbp]
    ...
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
      \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-SMP Erlang}
      \caption{SMP Erlang}
    \end{minipage}
  \end{figure}
  ...
  \begin{center}
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-code-snippet-02}
  \end{center}
  ...
  \end{itemize*}
  \begin{center}
    \includegraphics[width=0.4\linewidth]{Assets/Programmierparadigmen-code-snippet-03}
  \end{center}
  ...
  \end{itemize*}
  \begin{center}
    \includegraphics[width=0.4\linewidth]{Assets/Programmierparadigmen-code-snippet-04}
  \end{center}
  ...
  \begin{center}
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-code-snippet-11}
  \end{center}
  ...
  Quicksort in Erlang
  \begin{center}
    \includegraphics[width=0.4\linewidth]{Assets/Programmierparadigmen-code-snippet-12}
  \end{center}
  ...
  Zeitmessung:
  \begin{center}
    \includegraphics[width=0.4\linewidth]{Assets/Programmierparadigmen-code-snippet-13}
  \end{center}
  ...
  \end{itemize*}
  \begin{center}
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-mutex-c}
  \end{center}
...
\end{lstlisting}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-Aktormodell.png}
  \end{center}
...
\end{lstlisting}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-zustände-bit-protokoll.png}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20015}
  \end{center}
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20016}
  \end{center}
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20017}
  \end{center}
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20018}
  \end{center}
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20019}
  \end{center}
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20020}
  \end{center}
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20021}
  \end{center}
...
$\Rightarrow$ das Verhalten der Teilnehmer ist in \color{orange} Kommunikationsmodellen \color{black} beschrieben
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20024}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20025}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20026}
  \end{center}
  \color{orange} asynchrones Empfangen: \color{black} Der Empfänger macht weiter, falls keine Nachricht eingetroffen ist
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20027}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20028}
  \end{center}
  
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20029}
  \end{center}
...
\end{lstlisting}
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20030}
  ...
  \begin{itemize*}
    ...
    \begin{center}
      \centering
      \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20031}
    \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20032}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20033}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20034}
  \end{center}
  \begin{itemize*}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20035}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20036}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20037}
  \end{center}
  \begin{itemize*}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20038}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20039}
  \end{center}
  ...
  \begin{itemize*}
    ...
    \begin{center}
      \centering
      \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20040}
    \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20041}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20042}
  \end{center}
  Antwort: 
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20043}
  \end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20044}
\end{center}
...
\begin{itemize*}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20045}
  \end{center}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20046}
  \end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20047}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20048}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20049}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20050}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.9\linewidth]{Assets/Programmierparadigmen-20051}
\end{center}
...
\begin{itemize*}
  ...
  \begin{itemize*}
    ...
    \item 	\includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20052}
...
\begin{center}
  \centering
  \includegraphics[width=0.45\linewidth]{Assets/Programmierparadigmen-20053}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20054}
\end{center}
...
\begin{itemize*}
  ...
  \begin{center}
    \centering
    \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20055}
  \end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20056}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.65\linewidth]{Assets/Programmierparadigmen-20057}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.65\linewidth]{Assets/Programmierparadigmen-20058}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20059}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20060}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20061}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20062}
\end{center}
\begin{itemize*}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20063}
\end{center}
\begin{itemize*}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20064}
\end{center}

\subsubsection{Amazon AWS Produkte}
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20065}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20066}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20067}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20068}
\end{center}
\begin{itemize*}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20069}
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-20070}
\end{center}
\begin{itemize*}
