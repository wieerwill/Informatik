...
\footnotesize
  ...
  \subsection{Warum unterschiedliche Paradigmen?}
...
\subsubsection{Das untypisierte Lambdakalkül}
\begin{itemize}
...
\subsubsection{Das untypisierte $\lambda$-Kalkül}
...
\subsubsection{Anwendungsstrategien (2)}
...
\subsubsection{Anwendungsstrategien (3)}
...
\subsection{Werte und Primitive}
...
\subsection{Kodierung boolescher Werte}
...
\end{itemize}
\subsubsection{Kodierung natürlicher Zahlen}
...
\subsubsection{Rechnen mit Church - Zahlen (1)}
...
\subsubsection{Rechnen mit Church - Zahlen (2)}
Idee zu exp: 
...
\subsubsection{Rechnen mit Church - Zahlen (3)}
...
\subsubsection{Rechnen mit Church - Zahlen (4)}
\begin{center}
...
\subsection{Ausdrucksfähigkeit des Lambdakalküls}
\subsubsection{Ausdrucksstärke des Lambdakalküls}
\begin{itemize}
...
\subsubsection{Ausdrucksstärke des Lambdakalküls (2)}
\begin{itemize}
  ...
  \item Wir definieren nun die folgenden Eigenschaften:
        ...
        \end{itemize}
\end{itemize}
\subsubsection{Ausdrucksstärke des Lambda-Kalküls (3)}
\colorbox{lightgray}{\begin{minipage}[h]{1.0\linewidth}
    Definition: \\
...
\subsubsection{Ausdrucksstärke des Lambda-Kalküls (6)}
...
Symetrisch vs. Nicht-symetrisch
...
\subsection{Parallele Programmierung in Erlang - Teil 1}
...
\begin{itemize}
  ...
  \item Funktion spawn erzeugt einen Prozess, der die Funktion Fun ausführt \newline
        \color{blue} Pid \color{black} = \color{green} spawn\color{black}(\color{green} fun \color{blue} Fun\color{black}/0)
  ...
  \item Übergabe von Arghumenten an den Prozess bei der Erzeugung
        \newline \color{blue} Pid \color{black} = \color{green} spawn\color{black} (\color{green} fun\color{black} () $\rightarrow$ any\_func(Arg1, Arg2, …)\color{green} end\color{black})
\end{itemize}
\subsubsection{Prozesse in Erlang: Beispiele}
\begin{center}
...
\
\begin{itemize}
  \item[1.] \color{blue} Pid ! Message \color{black}
...
\end{center}
\subsubsection{Echo-Server: Erklärungen}
\begin{itemize}
...
\end{itemize}
\subsection{Parallele Programmierung in Erlang - Teil 2}
...
\subsubsection{pmap: Hilfsfunktionen}
...
\end{itemize}
\subsubsection{Parallele Berechnung der Fibonacci-Zahlen}
\begin{center}
...
\begin{itemize}
  ...
  \item Berechnungsaufwand der Prozesse
        ...
        \end{itemize}
\end{itemize}
\subsubsection{pmap: Alternative Implementierung}
\begin{itemize}
...
\end{center}
\subsubsection{Diskussion: Speedup}
...
\subsubsection{Speedup: Zeitmessung}
...
\end{center}
\subsubsection{Bestimmung: Speedup}
...
\end{center}
\subsubsection{Datenparallelität: Das MapReduce-Paradigma}
\begin{itemize}
  ...
  \item Grundidee:
        \begin{itemize}
          ...
          \item reduce(F, Seq) = wende eine Funktion F schrittweise auf die Elemente einer Folge Seq an und produziere einen einzelnen Wert,
                \begin{itemize}
                  \item z.B. die Summer aller Elemente einer Folge
                \end{itemize}
        \end{itemize}
\end{itemize}

\subsubsection{map in Erlang}
\begin{center}
  \includegraphics[width=0.9\linewidth]{Assets/Programmierparadigmen-044}
\end{center}
\subsubsection{reduce in Erlang}
\begin{center}
  \includegraphics[width=0.9\linewidth]{Assets/Programmierparadigmen-045}
\end{center}
\subsubsection{Parallelisierung von map und reduce}
\color{orange} map
\color{black} \begin{itemize}
...
\end{itemize}
\subsubsection{Parallelisierung von reduce}
\begin{center}
  \includegraphics[width=0.5\linewidth]{Assets/Programmierparadigmen-046}
\end{center}

\subsection{Parallele Programmierung in Erlang - Teil 3}
...
\subsubsection{Parallel Quicksort: Version 1}
Quicksort in Erlang
\begin{center}
...
\subsubsection{Parallel Quicksort: Version 2}
\begin{center}
...
\begin{itemize}
  ...
  \item Ziele für effiziente Parallelisierung:
        \begin{itemize}
          ...
          \item Sequentiellen Flaschenhals vermeiden (Zugriff auf gemeinsame Ressourcen: IO, Registrierung von Prozessen, ...)
          \item Small Messages, Big Computation!
        \end{itemize}
\end{itemize}
...
\end{center}
\subsubsection{Alternative Erzeugung von Threads}
...
\end{center}
\subsubsection{Parameterübergabe bei Threaderzeugung}
\begin{itemize}
...
\end{center}
\subsubsection{Warten auf Threads}
\begin{itemize}
...
\end{center}
\subsubsection{Hintergrundthreads}
\begin{itemize}
...
\end{itemize}
\subsubsection{Threadidentifikation}
\begin{itemize}
...
\end{center}
\subsubsection{Berechnung von Fibonacci-Zahlen in C++}
\begin{itemize}
...
\begin{itemize}
  ...
  \item \color{orange} aber: \color{black}
        ...
        \end{itemize}
\end{itemize}
\subsubsection{parallel-for in C++}
\begin{itemize}
...
\end{center}
\subsubsection{Kontrolle der Anzahl der Threads}
\begin{itemize}
...
\end{center}
\subsubsection{Lock Gurads und Locks}
\begin{itemize}
  ...
  \item Sperrstrategien: u.a.
        ...
        \end{itemize}
\end{itemize}
\subsubsection{Atomare Datentypen}
\begin{itemize}
...
\end{itemize}
\subsubsection{Synchronisation über atomare Variable}
\begin{center}
...
\end{itemize}
\subsubsection{Das Problem mit den Philosophen}
\begin{itemize}
...
\end{itemize}
\subsubsection{Verklemmungsfreies Sperren}
\begin{center}
...
\end{center}
\subsubsection{Das Dinner: Initialisierung}
\begin{center}
  \includegraphics[width=0.7\linewidth]{Assets/Programmierparadigmen-080}
\end{center}
\subsubsection{Das Dinner beginnt}
\begin{itemize}
...
\color{orange} Thread-Sicherheit:= \color{black} eine Komponente kann gleichzeitig von verschiedenen Programmbereichen Threads mehrfach ausgeführt werden, ohne dass diese sich gegenseitig behindern \newline \newline
...
\end{itemize}
\subsubsection{Thread-sichere Queue: Methode push}
\begin{center}
...
\end{itemize}
\subsubsection{Thread-sichere Queue: Methode waiting\_pop}
\begin{center}
...
\begin{itemize}
  ...
  \item Implementierung eines eigenen Kontrollflusses
        ...
        \end{itemize}
\end{itemize}
\subsubsection{Threads: Runnable-Schnittstelle}
...
\end{center}
\subsubsection{Thread-Erzeugung}
\begin{itemize}
...
\end{center}
\subsubsection{Threads: Subklasse von Thread}
\begin{itemize}
...
\begin{itemize}
  ...
  \item Spätere Beeinflussung durch andere Threads möglich
        ...
        \end{center}
\end{itemize}
\subsubsection{Threads: Wichtige Methoden}
\begin{itemize}
...
\begin{itemize}
  ...
  \item Zugriff auf das Ergebnis mit \textbf{get}
        ...
        \end{itemize}
\end{itemize}
\subsubsection{Future \& ExecutorService: Beispiel}
\begin{center}
...
\begin{itemize}
  ...
  \item \textbf{ForkJoinPool} zum Ausführen
        ...
        \end{itemize}
\end{itemize}
\subsubsection{Fork/Join: Beispiel}
\begin{center}
